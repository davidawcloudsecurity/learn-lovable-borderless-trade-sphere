      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300">
              The world's leading global commerce platform connecting buyers and sellers across borders.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Intellectual Property</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Trade Compliance</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 GlobalTrade. All rights reserved. | Connecting the world through commerce.
          </p>
        </div>
      </div>
    </footer>
